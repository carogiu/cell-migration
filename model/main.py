...
def main_model(config):
    ...
    # Less exact, but faster and no difference in the growth rate observed yet
    ...
    if model == 'darcy':
        ...
        if alpha == 0:
            ...
            time_evolution_passive_darcy_2_solvers(mesh=mesh, dim_x=dim_x, dim_y=dim_y, dt=dt, n=n, space_ME=space_ME,
                                                   w_flow=w_flow, theta=theta, Cahn=Cahn, Pe=Pe, Ca=Ca,
